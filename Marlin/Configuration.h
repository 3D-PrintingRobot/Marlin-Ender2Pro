...
#define STRING_CONFIG_H_AUTHOR "Dylan J Muller" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Printing Robot"
...
#define Z_AFTER_HOMING         25   // (mm) Height to move to after homing (if Z was homed)
